...
<<<<<<< HEAD:var/cache/dev/ContainerPXEjw9x/getRessourcesRepositoryService.php
namespace ContainerPXEjw9x;

=======
<<<<<<<< HEAD:var/cache/dev/Container5bYnsck/getRessourcesRepositoryService.php
namespace Container5bYnsck;

========
namespace ContainerBg3qXMC;
>>>>>>>> 7b24a4db39587ab85a1972100e28e5aa92097661:var/cache/dev/ContainerBg3qXMC/getRessourcesRepositoryService.php
>>>>>>> 2acf55cd003850f9f9b822e41246069addbeb4cb:var/cache/dev/ContainerBg3qXMC/getRessourcesRepositoryService.php
 ...
 */
class getRessourcesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RessourcesRepository' shared autowired service.
     *
     * @return \App\Repository\RessourcesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RessourcesRepository.php';

        return $container->privates['App\\Repository\\RessourcesRepository'] = new \App\Repository\RessourcesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
