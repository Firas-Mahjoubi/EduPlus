...
class __TwigTemplate_6520b69917fa64aadcde8f5e26f5f8cb extends Template
{
     ...
     <div class=\"input-group\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ressource"]) {
            ...
            yield "</td>
                        <td>";
            // line 43
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["ressource"], "montant", [], "any", false, false, false, 43)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["ressource"], "montant", [], "any", false, false, false, 43), "html", null, true)) : ("-"));
            yield "</td>
                        <td>";
            // line 44
            yield ((CoreExtension::getAttribute($this->env, $this->source, $context["ressource"], "quantite", [], "any", false, false, false, 44)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["ressource"], "quantite", [], "any", false, false, false, 44), "html", null, true)) : ("-"));
            yield "</td>
                        <td>";
            // line 45
...
{% endblock %}
", "g_ressources/backOffice/index.html.twig", "C:\\Users\\ghass\\Desktop\\Eduplus1\\EduPlus\\templates\\g_ressources\\backOffice\\index.html.twig");
    }
}
