...
/* g_ressources/confirm_demande.html.twig */
class __TwigTemplate_f8ef5fe934f3df71b3f6bb487416ee53 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "g_ressources/confirm_demande.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "g_ressources/confirm_demande.html.twig"));

        $this->parent = $this->loadTemplate("base_backoffice.html.twig", "g_ressources/confirm_demande.html.twig", 1);
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
            ...
            <div class=\"col-md-8\">
                <div class=\"card\">
                    <div class=\"card-header\">
                        <h2>Confirm demande?</h2>
                    </div>
                    <div class=\"card-body\">
                        <p>Êtes-vous sûr de vouloir demander la ressource <strong>";
        // line 14
        ...
        yield "\" class=\"btn btn-secondary\">Annuler</a>
                                <button type=\"submit\" class=\"btn btn-danger\">Demande</button>
                            </div>
                        </form>
                    </div>
                </div>
...
";
    ...
    {
        return "g_ressources/confirm_demande.html.twig";
    }
...
{% block title %}Confirmer la demande{% endblock %}
        ...
        <div class=\"row justify-content-center\">
            <div class=\"col-md-8\">
                <div class=\"card\">
                    ...
                    <div class=\"card-body\">
                        <p>Êtes-vous sûr de vouloir demander la ressource <strong>{{ ressource.nomRessource }}</strong> ?</p>
                        <form action=\"{{ path('ressource_delete', { 'id': ressource.id }) }}\" method=\"post\">
                            ...
                            <div class=\"d-flex justify-content-between\">
                                <a href=\"{{ path('app_g_ressourcess') }}\" class=\"btn btn-secondary\">Annuler</a>
                                <button type=\"submit\" class=\"btn btn-danger\">Demande</button>
                            </div>
                        </form>
                    </div>
...
{% endblock %}
", "g_ressources/confirm_demande.html.twig", "C:\\Users\\ghass\\Desktop\\Eduplus1\\EduPlus\\templates\\g_ressources\\confirm_demande.html.twig");
    }
}
