 ...
 */
class getApplicationClubRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ApplicationClubRepository' shared autowired service.
     *
     * @return \App\Repository\ApplicationClubRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApplicationClubRepository.php';

        return $container->privates['App\\Repository\\ApplicationClubRepository'] = new \App\Repository\ApplicationClubRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
