 ...
 */
class getEventMessageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EventMessageRepository' shared autowired service.
     *
     * @return \App\Repository\EventMessageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EventMessageRepository.php';

        return $container->privates['App\\Repository\\EventMessageRepository'] = new \App\Repository\EventMessageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
