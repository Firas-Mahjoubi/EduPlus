...
return [
    ...
    'application_decision' => [['id'], ['_controller' => 'App\\Controller\\GRecrutementsController::decideApplication'], [], [['text', '/decision'], ['variable', '/', '[^/]++', 'id', true], ['text', '/g/recrutements/application']], [], [], []],
    ...
    'App\Controller\GRecrutementsController::decideApplication' => [['id'], ['_controller' => 'App\\Controller\\GRecrutementsController::decideApplication'], [], [['text', '/decision'], ['variable', '/', '[^/]++', 'id', true], ['text', '/g/recrutements/application']], [], [], []],
